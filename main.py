    """
    Markdown To Html Api Anf2qh
    ===========================
    Production-ready REST API component built to transform web requests at scale.
    ...
    APP_NAME    = "Markdown To Html Api Anf2qh"
    APP_VERSION = "1.0.0"
...
return app
    ...
    def build_parser() -> argparse.ArgumentParser:
        p = argparse.ArgumentParser(prog=APP_NAME, description="Production-ready REST API component built to transform web requests at scale.")
